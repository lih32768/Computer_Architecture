...
#
# Script generated by Vivado on Tue Dec 17 21:43:11 +0800 2024
...
# script info
echo -e "multiplier.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_13 -L xbip_pipe_v3_0_9 -L xbip_bram18k_v3_0_9 -L mult_gen_v12_0_21 -L xil_defaultlib -L secureip -L xpm --snapshot multiplier xil_defaultlib.multiplier -log elaborate.log
}
